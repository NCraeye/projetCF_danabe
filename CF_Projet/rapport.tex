...
\author{Poulet \and Poule \and Friture}
...
Cette constante permet de lancer une configuration du système avec un nombre de pannes connues. 
L'assert du noeud System assure, lors du lancement du modèle par l'utilisateur, que ce dernier a une configuration qui fait sens : le nombre de pannes étant limité au nombre de vannes existantes dans le modèle en cours.

$ValveVirtual$ est le composant permet de simuler une valve parfaite (sans panne)
