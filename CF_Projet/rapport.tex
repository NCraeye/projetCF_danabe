...
$nbFailures$ est la constante qui limite le nombre de vannes pouvant tomber en panne simultanément. Elle permet de lancer une configuration du système avec un nombre de pannes connues. 
